...
#define DO_WT false    //do everything related to WaveTrigger
...
#define G_INTERNALMOODS 9          //internal moods
...
#define G_INTERNALINSTR2PATTERNS 7
#define G_INTERNALINSTR3PATTERNS 8
#define G_INTERNALINSTR4PATTERNS 8
#define G_INTERNALINSTR5PATTERNS 7
#define G_INTERNALINSTR6PATTERNS 6
